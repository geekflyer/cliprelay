...
class DebugSmokeReceiver : BroadcastReceiver() {
    companion object {
        const val ACTION_IMPORT_PAIRING = "com.cliprelay.debug.IMPORT_PAIRING"
        const val ACTION_CLEAR_PAIRING = "com.cliprelay.debug.CLEAR_PAIRING"
        const val ACTION_RESET_PROBE = "com.cliprelay.debug.RESET_PROBE"
